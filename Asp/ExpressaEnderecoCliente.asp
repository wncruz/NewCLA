...
<html>
	<head>
		...
		function Vazio()
		{
			if(document.getElementById('txtNome').value  == "" && document.getElementById('txtNro').value  == "" && document.getElementById('txtBairro').value  == "" && document.getElementById('txtCep').value  == "" && document.getElementById('txtCidade').value  == "" && document.getElementById('txtEstado').value  == "" && document.getElementById('txtNomeCliente').value  == "" && document.getElementById('txtConta').value  == "")
			{
				return true;
			}
		...
		function Procurar(){
			...
			with (document.forms[0])
			{
				...
				target = "IFrmLista"
				action = "ExpressaListarEnderecoCliente.asp"
				submit()
			}
		}
	...
	<body>
		<form method="post" name=Form1 >
			...
			<table border=0 cellspacing="1" cellpadding = 0 width="760" >
				<tr class=clsSilver>
					<th colspan=2><p align=center>Consulta Expressa - Endereço + Cliente</p></th>
				</tr>
				<tr>
				...
				<tr class=clsSilver>
					...
					<td>
						<input type="text" class="text" name="txtNomeCliente" onclick="document.Form1.btnProcurar.disabled=false;" onKeyUp="HabilitaProcurar(this)" maxlength="60" size="65">
					</td>
				</tr>
				<tr class=clsSilver>
				...
				<tr class=clsSilver>
					...
					<td>
						...
						&nbsp;&nbsp;&nbsp;Cidade:				
						<input type="text" class="text" name="txtCidade" onclick="document.Form1.btnProcurar.disabled=false;" onKeyUp="HabilitaProcurar(this)" maxlength="4" size="4">
						&nbsp;&nbsp;CEP:					
						<input type="text" class="text" name="txtCep" onclick="document.Form1.btnProcurar.disabled=false;" onKeyUp="HabilitaProcurar(this)" maxlength="9" size="10" onKeyPress="OnlyNumbers();AdicionaBarraCep(this)">
					</td>
				</tr>
				<tr class=clsSilver>
					<td>&nbsp;&nbsp;&nbsp;Estado:</td>
