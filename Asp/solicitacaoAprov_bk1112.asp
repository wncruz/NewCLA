...
function VerificaFacilidade(lstfac, facText) {
	...
	if(facText.toString() === ":: FACILIDADE" ) { achou = true;} ;
    if (!achou) {
...
'			  'response.write "<script>alert('yyy="&objRSSolic("Id_Acesso")&"')</script>"
			...
			strHtmlGla	= "<table cellspacing=1 cellpadding=0 width=790px border=0 ><tr class=clsSilver >"
...
if (strIDLogico <> "" and (strAcao = "ALT" or strAcao = "ATV"))  then
	...
	<tr class="clsSilver">
		...
		<td colspan="4"><span id=spnCliente></span></td>
                ...
                <table border="0" cellspacing="1" cellpadding="0" width="790">
                    <tr>
                        <th colspan="8">&nbsp;•&nbsp;Informações do Serviço&nbsp;
                        </th>
                    </tr>
                        ...
                        <td colspan="3">
                            <table border="0" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr class="clsSilver">
                                    ...
                                    <td>-</td>
                                    <td>
                                        <input type="text" class="text" onblur="CompletarCampo(this);hdnOrderEntryAno.value=this.value;" onkeyup="ValidarTipo(this,0)" maxlength="4" size="4" <%=bbloqueia%> name="txtOrderEntry" tipo="N" value="<%=strOrderEntryAno%>"></td>
                                    <td>-</td>
                                    <td>
                                        <input type="text" class="text" onblur="CompletarCampo(this);hdnOrderEntryNro.value=this.value;" onkeyup="ValidarTipo(this,0)" maxlength="7" size="7" <%=bbloqueia%> name="txtOrderEntry" tipo="N" value="<%=strOrderEntryNro%>"></td>
                                    <td>-</td>
                                    <td>
                                        <input type="text" class="text" onblur="CompletarCampo(this);hdnOrderEntryItem.value=this.value;" onkeyup="ValidarTipo(this,0)" maxlength="3" size="3" <%=bbloqueia%> name="txtOrderEntry" tipo="N" value="<%=strOrderEntryItem%>"></td>
                                    <td colspan="5"></td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="5">
                            <table border="0" border="0" cellspacing="0" cellpadding="0">
                                <tr align="center" class="clsSilver">
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td width="400px" align="right" colspan="8"><font class="clsObrig"></font>&nbsp;</td>
                                </tr>
                                <tr class="clsSilver">
                                    <td>
                                        <select name="cboSistemaOrderEntry" <%=bbloqueia%> onchange="SistemaOrderEntry(this);hdnOrderEntrySis.value=this.value;">
                                    ...
                                    <td>-</td>
                                    <td colspan="3">
                                        <input type="text" class="text" maxlength="50" size="50" <%=bbloqueia%> name="txtIA" tipo="N" value="<%=strIA%>"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
			...
			set objRS = db.execute("CLA_sp_sel_servico null,null,null,1")
				...
				strItemSel = ""
                    ...
                    <tr class="clsSilver">
                        ...
                        <td colspan="8"><span id="spnVelServico">
                    ...
                    <tr class="clsSilver">
                        ...
                        <td colspan="8">
                            <table rules="groups" cellspacing="1" cellpadding="0" bordercolorlight="#003388" bordercolordark="#ffffff" width="70%">
                                <tr>
                                    <td nowrap width="200px">
                                        <input type="radio" name="rdoNroContrato" value="1"
                                            <%=bbloqueia%>
                                            onclick="spnDescNroContr.innerHTML= 'Ex.: VEM-11 XXX000012003'" checked <%if strTipoContratoServico = "1" then Response.Write " checked " End if%>>Contrato de Serviço</td>
                                    <td></td>                                    
                                </tr>
                                <tr>
                                    <td nowrap>
                                        <input type="radio" name="rdoNroContrato" onclick="spnDescNroContr.innerHTML= 'Padrão: A22'"
                                            <%=bbloqueia%>
                                ...
                                <tr>
                                    <td nowrap>
                                        <input type="radio" name="rdoNroContrato"
                                            <%=bbloqueia%>
                                            onclick="spnDescNroContr.innerHTML= 'Padrão: A22'" value="3" <%if strTipoContratoServico = "3" then Response.Write " checked " End if%>>Carta de Compromisso</td>
                                    <td></td>
                                </tr>
                            </table>
                        </td>
	...
	if Trim(Request.Form("hdnAcao")) = "Alteracao" then %>
                    ...
                    <tr>
                        <th colspan="4">&nbsp;•&nbsp;Informações de Alteração</th>
                    </tr>
...
-->
  ...
  -->
	...
	-->
        ...
        <tr>
            <th colspan="4">&nbsp;•&nbsp;Acessos Físicos Utilizados</th>
        </tr>
        <tr>
            <td colspan="4">
...
Next
        ...
        <tr class="clsSilver">
            ...
            <td>
                <input type="text" class="text" name="txtCepEnd" readonly="readOnly" value="<%=strCepEnd%>" maxlength="9" size="12">
        ...
        <tr class="clsSilver2">
            <td width="170px"><span id="spnDestino">&nbsp;&nbsp;&nbsp;Sigla Estação Entrega<br>
                &nbsp;&nbsp;&nbsp;do Acesso Físico</span></td>
            <td colspan="3" nowrap>
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="text" name="txtCNLSiglaCentroCliDest" maxlength="4" size="8" onkeyup="ValidarTipo(this,1)" value="<%=strCNLSiglaCli%>" onblur="CompletarCampo(this)" tipo="A">&nbsp;</td>
...
<table border="0" cellspacing="1" cellpadding="0" width="790">
    <tr>
        <td>
            <form name="Form3" method="Post">
                ...
                <input type="hidden" name="hdnNecessitaRecurso" value="S">
                <!-- Na ativação será sempre SIM -->
                ...
                <input type="hidden" name="hdnReaproveitarFisico" value="N">
                <!-- Na ativação será sempre Não. Será modificado na Alteração -->
                <%if objRSSolic("OriSol_ID") <> 9 then%>
                <tr>
    ...
    <tr class="clsSilver">
        <td nowrap width="170px" class="clsSilver">&nbsp;&nbsp;&nbsp;&nbsp;Username
            <br>
            &nbsp;&nbsp;&nbsp;&nbsp;do Cadastrador</td>
        <td nowrap class="clsSilver">
            <input type="text" class="text" name="txtUsernamecadastrador"
                <%=bbloqueia%>
                value="<%=strUsernamecadastrador%>" maxlength="20" size="20" onkeypress="">&nbsp;</td>
        <td nowrap class="clsSilver">&nbsp;Telefone Cadastrador<br>
            &nbsp;</td>
        <td nowrap class="clsSilver">
            <input type="text" class="text" name="txtTelefoneCadastrador"
                <%=bbloqueia%>
    ...
    <tr class="clsSilver">
        ...
        <td colspan="3">
            <textarea name="txtObs" onkeydown="MaxLength(this,300);" cols="50" rows="3" readonly="true" <%=bbloqueia%>><%=strObservacao%></textarea></td>
    </tr>
    <% end if %>
    <%
...
<table border="0" cellspacing="1" cellpadding="0" width="790">
    ...
    <tr class="clsSilver">
        <td width="170px"><font class="clsObrig">:: </font>Local de Entrega<br>
            &nbsp;&nbsp;&nbsp;do Acesso Lógico</td>
        <input type="Hidden" name="cboLocalEntrega">
        <td colspan="3">
            <input type="text" class="text" name="txtCNLLocalEntrega" maxlength="4" size="6" onkeyup="ValidarTipo(this,1)" onblur="CompletarCampo(this)" tipo="A">&nbsp;
    ...
    <tr class="clsSilver">
        ...
        <td colspan="3">
            <input type="text" class="text" name="txtCNLLocalConfig" maxlength="4" size="6" onkeyup="ValidarTipo(this,1)" onblur="CompletarCampo(this)" tipo="A">&nbsp;
