<%
'	- Sistema			: CLA
'	- Arquivo			: ListarErrosFacMig.asp
'	- Autor			: Alexandre Soares
'	- Descrição		: Lista Endereços para serem corrigidas
%>
...
Const con_UF		 = 0
Const con_AnoMes	 = 1
Const con_TotErros	 = 2 
Const con_TotAcertos = 3
Const con_TotGeralAcertos = 4
Const con_TotGeralErros = 5
Const con_TotMeses	 = 6

strSQL = " CLA_sp_QtdeErrosMigEndUF "
...
'strHtmlRet = strHtmlRet & "<table border='0' cellspacing='1' cellpadding=0 width=760> " & chr(13)
'strHtmlRet = strHtmlRet & " <tr> " & chr(13)
'strHtmlRet = strHtmlRet & " <th colspan=" & ColSpan & "><p align='center'>Acertos de Migração (Facilidade) - Emitido em: " & DataEmissao & "</p></th> " & chr(13)
'strHtmlRet = strHtmlRet & " </tr> " & chr(13)
'strHtmlRet = strHtmlRet & " <tr class=clsSilver>" & chr(13)
'strHtmlRet = strHtmlRet & " <td ></td>" & chr(13)
'strHtmlRet = strHtmlRet & " </tr>" & chr(13)
'strHtmlRet = strHtmlRet & " </table>" & chr(13)


'strHtmlRet = strHtmlRet & " <div id=Div_Lista class=Div_Lista>" & chr(13)
strHtmlRet = strHtmlRet & " <table border='0' cellspacing='1' cellpadding=0 width=" & TamanhoTab & ">" & chr(13)
strHtmlRet = strHtmlRet & " <tr>" & chr(13)
strHtmlRet = strHtmlRet & " <th colspan=" & 4+ColSpan & "><p align='center'>Acertos de Migração (Endereço) - Emitido em: " & DataEmissao & "</p></th> " & chr(13)
strHtmlRet = strHtmlRet & " </tr>" & chr(13)
strHtmlRet = strHtmlRet & " <tr>" & chr(13)
	strHtmlRet = strHtmlRet & " <th rowspan=2 align=center width=40>&nbsp;UF</th>" & chr(13)
	strHtmlRet = strHtmlRet & " <th rowspan=2 align=center width=125>&nbsp;Total Erros Migração</th>" & chr(13)
	strHtmlRet = strHtmlRet & " <th rowspan=2 align=center width=90>&nbsp;Total Acertos</th>" & chr(13)
	strHtmlRet = strHtmlRet & " <th rowspan=2 align=center width=100>&nbsp;Total Erros Atual </th>" & chr(13)
	strHtmlRet = strHtmlRet & " <th colspan=" & ColSpan & " align=center>&nbsp;Acertos</th>" & chr(13)
strHtmlRet = strHtmlRet & " </tr>" & chr(13)
strHtmlRet = strHtmlRet & " <tr>" & chr(13)
...
If TotalRegArray > 0 then
	...
	For i = 0 to TotalRegArray
		...
		If UFAtual <> ArrayErros(con_UF,i) then
			...
			strHtmlRet = strHtmlRet & " <td>&nbsp;" & ArrayErros(con_TotGeralErros,i)& "</td>" & chr(13) 
			strHtmlRet = strHtmlRet & " <td>&nbsp;" & ArrayErros(con_TotGeralAcertos,i)& "</td>" & chr(13) 
			strHtmlRet = strHtmlRet & " <td>&nbsp;" & ArrayErros(con_TotGeralErros,i)-ArrayErros(con_TotGeralAcertos,i)& "</td>" & chr(13) 
			j = 0
			For j = 0 to TotalMeses
				If ArrayErros(con_AnoMes,i) = ArrayMes(0, j) then	
					strHtmlRet = strHtmlRet & " <td>&nbsp;" & ArrayErros(con_TotAcertos,i) & "</td>" & chr(13) 
					Teste = "OK"
