...
Call APENDA_PARAM("CLA_sp_ins_NewManutencaoAlocarFacilidade2",48,Vetor_Campos)
...
ELSE
	%>
		alert('Facilidades Alteradas com sucesso!');
		window.location.replace('ManutencaoAlocacaoNew_main.asp');
		//parent.window.close();
	<%
END IF
%>
