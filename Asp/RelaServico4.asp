...
<%
if strLoginRede = "EDAR" or strLoginRede = "Z022257" or strLoginRede = "SCESAR" or strLoginRede = "PABS"  or strLoginRede = "Z032533" or strLoginRede = "T3FRRP" or strLoginRede = "T3LMACE" or strLoginRede = "LINDAMM" or strLoginRede = "ALEJDC" or strLoginRede = "SINGO" then
	%>
	<html>
	...
	%>
	<form name="Form_1" method="post" action="RelaServico4.asp">
