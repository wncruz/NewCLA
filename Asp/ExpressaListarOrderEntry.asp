...
Vetor_Campos(4)="adWChar,2,adParamInput, null"
Vetor_Campos(5)="adWChar,30,adParamInput, null"
Vetor_Campos(6)="adWChar,9,adParamInput, null"
Vetor_Campos(7)="adWChar,60,adParamInput, null"
Vetor_Campos(8)="adWChar,10,adParamInput, null"
...
Vetor_Campos(13)="adWChar,30,adParamInput, " & Request.Form("cboSistema")

strSql = APENDA_PARAMSTR("CLA_sp_sel_MetaDados",13,Vetor_Campos)
...
if not objRSPag.Eof and not objRSPag.Bof then
	...
	strHtmlRet = strHtmlRet & "<th nowrap >&nbsp;OE_Sistema</th>"
	strHtmlRet = strHtmlRet & "<th nowrap >&nbsp;OE_Numero</th>"
	strHtmlRet = strHtmlRet & "<th nowrap >&nbsp;OE_Ano</th>"
	strHtmlRet = strHtmlRet & "<th nowrap >&nbsp;OE_Item</th>"
	...
	strXlsRet = strXlsRet & "<th nowrap >&nbsp;OE_Sistema</th>"
	strXlsRet = strXlsRet & "<th nowrap >&nbsp;OE_Numero</th>"
	strXlsRet = strXlsRet & "<th nowrap >&nbsp;OE_Ano</th>"
	strXlsRet = strXlsRet & "<th nowrap >&nbsp;OE_Item</th>"
	...
	For intIndex = 1 to objRSPag.PageSize
		...
		strHtmlRet = strHtmlRet & "<td nowrap><span id=spnCliente>" & objRSPag("OE_Sistema") & "</span></td>"
		strHtmlRet = strHtmlRet & "<td nowrap><span id=spnCliente>" & objRSPag("OE_Numero") & "</span></td>"
		strHtmlRet = strHtmlRet & "<td nowrap><span id=spnCliente>" & objRSPag("OE_Ano") & "</span></td>"
		strHtmlRet = strHtmlRet & "<td nowrap><span id=spnCliente>" & objRSPag("OE_Item") & "</span></td>"
		...
		strXlsRet = strXlsRet & "<td nowrap >" & objRSPag("OE_Sistema") & "</td>"
		strXlsRet = strXlsRet & "<td nowrap >" & objRSPag("OE_Numero") & "</td>"
		strXlsRet = strXlsRet & "<td nowrap >" & objRSPag("OE_Ano") & "</td>"
		strXlsRet = strXlsRet & "<td nowrap >" & objRSPag("OE_Item") & "</td>"
