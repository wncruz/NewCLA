...
<html>
	...
	<body leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0">
		<form name=Form1 method=Post onSubmit="return false">
			...
			<input type=hidden  name=txtNro   	          value="<%=Request.Form("txtNro")%>">
			<input type=hidden  name=txtBairro   	      value="<%=Request.Form("txtBairro")%>">
			<input type=hidden  name=txtCep   	  	      value="<%=Request.Form("txtCep")%>">
			<input type=hidden  name=txtEstado   	      value="<%=Request.Form("txtEstado")%>">
...
Vetor_Campos(2)="adWChar,60,adParamInput," & Request.Form("txtNomeCliente") 
Vetor_Campos(3)="adWChar,15,adParamInput," & Request.Form("txtConta") 
Vetor_Campos(4)="adWChar,2,adParamInput, " & Request.Form("txtEstado")
Vetor_Campos(5)="adWChar,30,adParamInput," & Request.Form("txtBairro") 
Vetor_Campos(6)="adWChar,9,adParamInput," & Request.Form("txtCep") 
Vetor_Campos(7)="adWChar,60,adParamInput," & Request.Form("txtNome") 
Vetor_Campos(8)="adWChar,10,adParamInput," & Request.Form("txtNro")
Vetor_Campos(9)="adWChar,7,adParamInput, " & Request.Form("txt_oe_numero")
Vetor_Campos(10)="adWChar,4,adParamInput, " & Request.Form("txt_oe_ano")
Vetor_Campos(11)="adWChar,3,adParamInput, " & Request.Form("txt_oe_item")
Vetor_Campos(12)="adWChar,3,adParamInput, " & Request.Form("txtCidade")

strSql = APENDA_PARAMSTR("CLA_sp_sel_MetaDados",12,Vetor_Campos)
...
if not objRSPag.Eof and not objRSPag.Bof then
	...
	strHtmlRet = strHtmlRet & "<th nowrap >&nbsp;Tipo Logradouro</th>"
	strHtmlRet = strHtmlRet & "<th nowrap >&nbsp;Nome Logradouro</th>"
	strHtmlRet = strHtmlRet & "<th nowrap >&nbsp;Número</th>"
	strHtmlRet = strHtmlRet & "<th nowrap >&nbsp;Bairro</th>"
	strHtmlRet = strHtmlRet & "<th nowrap >&nbsp;Cidade</th>"
	...
	strXlsRet = strXlsRet & "<th nowrap >&nbsp;Tipo Logradouro</th>"
	strXlsRet = strXlsRet & "<th nowrap >&nbsp;Nome Logradouro</th>"
	strXlsRet = strXlsRet & "<th nowrap >&nbsp;Número</th>"
	strXlsRet = strXlsRet & "<th nowrap >&nbsp;Bairro</th>"
	strXlsRet = strXlsRet & "<th nowrap >&nbsp;Cidade</th>"
	...
	For intIndex = 1 to objRSPag.PageSize
		...
		strHtmlRet = strHtmlRet & "<td nowrap><span id=spnCliente>" & objRSPag("Tpl_Sigla") & "</span></td>"
		strHtmlRet = strHtmlRet & "<td nowrap><span id=spnCliente>" & objRSPag("End_NomeLogr") & "</span></td>"
		strHtmlRet = strHtmlRet & "<td nowrap><span id=spnCliente>" & objRSPag("End_NroLogr") & "</span></td>"
		strHtmlRet = strHtmlRet & "<td nowrap><span id=spnCliente>" & objRSPag("End_Bairro") & "</span></td>"
		strHtmlRet = strHtmlRet & "<td nowrap><span id=spnCliente>" & objRSPag("cidade") & "</span></td>"
		...
		strXlsRet = strXlsRet & "<td nowrap >" & objRSPag("Tpl_Sigla") & "</td>"
		strXlsRet = strXlsRet & "<td nowrap >" & objRSPag("End_NomeLogr") & "</td>"
		strXlsRet = strXlsRet & "<td nowrap >" & objRSPag("End_NroLogr") & "</td>"
		strXlsRet = strXlsRet & "<td nowrap >" & objRSPag("End_Bairro") & "</td>"
		strXlsRet = strXlsRet & "<td nowrap >" & objRSPag("cidade") & "</td>"
