...
'		if objRSedit.eof then
		...
		<tr class="clsSilver">
			<td>&nbsp;&nbsp;Designação ONT | EDD</td><td>&nbsp;&nbsp; <input type="text" class="text" name="txtDesigONT" value="<%=trim(objRS("Ont_Desig"))%>" size="25" maxlength="20" <%IF trim(objRS("Ont_Desig")) <> "" THEN%>readonly<%END IF%>></td><td>&nbsp;&nbsp;</td>
		</tr>
