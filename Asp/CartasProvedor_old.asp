...
function DetalheCarta(intDoc,strDocTipo,intProId)
{
	with (document.forms[0])
	{
		...
		{
			strRet = window.showModalDialog("CartasProvedorDet.asp?intDoc="+intDoc+"&strDocTipo="+strDocTipo+"&intProId="+intProId,"",'dialogHeight: 200px; dialogWidth: 600px; dialogTop: px; dialogLeft: px; edge: Raised; center: Yes; help: No; resizable: No; status: No;');
		}else
		{
			strRet = window.showModalDialog("CartasProvedorDet.asp?intDoc="+intDoc+"&strDocTipo="+strDocTipo+"&intProId="+intProId,"","dialogHeight: 580px; dialogWidth: 765px; dialogTop: px; dialogLeft: px; edge: Raised; center: Yes; help: No; resizable: Yes; status: No;");
		}	
	}	
}
...
<div id=divXls style="display:none;POSITION:relative">
	...
	<a href="javascript:AbrirXls()" onmouseover="showtip(this,event,'Consulta em formato Excel...')"><img src='../imagens/excel.gif' border=0></a>&nbsp;
...
<tr>
	<th width=15px></th>
	<th width=20px></th>
	<th width=130px>Cliente</th>
	<th width=100px>Pedido</th>
	<th width=65p>Data Envio</th>
