...
'strLoginRede = "EDAR"
IF strLoginRede <> "EDAR" and strLoginRede <> "Z022257"  and strLoginRede <> "SCESAR" and strLoginRede <> "Z032533" and strLoginRede <> "HARLEY" and strLoginRede <> "T3FRRP" and strLoginRede <> "LINDAMM" and strLoginRede <> "ALEJDC" and strLoginRede <> "SINGO" THEN
...
<form name="Form_1" method="post" action="Rela.asp">
