...
<table  border=0 cellspacing="1" cellpadding="0" width="760" >
	<tr >
		<td align=center>
			...
			<input type="button" class="button" name="btnAprovar" value=" Aprovar " onClick="AprovarAlteracao(<%dblSolId%>)" style="width:100px" accesskey="A" onmouseover="showtip(this,event,'Aprovar (Alt+A)');">
			<input type="button" class="button" name="btnDevolver" value=" Devolver p/ GIC " onClick="DevolverParaGIC()" style="width:100px" accesskey="D" onmouseover="showtip(this,event,'Devolver p/ GIC (Alt+D)');">
