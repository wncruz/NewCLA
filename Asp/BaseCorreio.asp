...
<tr class=clsSilver>
	<td>CEP</td>
	<td><input type="text" class="text" name="txtCepConsulta" value =  '<% = strCepConsulta %>'  maxlength="8" size="9" onKeyPress="OnlyNumbers();" >(99999999)
...
<td><input type="text" class="text" name="txtCep" value="<%=strCEP%>" maxlength="8" size="9" onKeyPress="OnlyNumbers();" >(99999999)</td>
</tr>
...
<tr >
	<td colspan=2 align="center"><br>
		...
		<!--Alterado por Fabio Pinho em 5/05/2016 - ver 1.0 - Inicio-->
		<!--<%Response.Write "<script language=javascript>alert('" & strLoginRede & "')</script>"%>-->
		<%if Trim(strLoginRede) = "EDAR" or Trim(strLoginRede) = "T3FRRP" or Trim(strLoginRede) = "SCESAR" then%>
