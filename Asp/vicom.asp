...
strParmProc = dblProId + "|" + dblPedId  + "|" + intTipoProcesso + "|" + strUserName 
	...
	if not isnull(objRSped1("esc_nomelogr")) then 
		...
		strXML = strXML &	"<arquivo>vicom</arquivo>"
		...
		strXML = strXML &	"<servicocontrato>" & trim(objRSped1("Acl_NContratoServico")) & "</servicocontrato>"
		strXML = strXML &	"<designacaoservico>" & trim(objRSped1("Acl_DesignacaoServico")) & "</designacaoservico>"
		strXML = strXML &	"<servicodescricao>" & trim(objRSped1("Ser_Desc")) & "</servicodescricao>"
		...
		strXML = strXML &	"<telgicl>" & strTelefoneGICL & "</telgicl>"
		strXML = strXML &	"</ROOT>"
