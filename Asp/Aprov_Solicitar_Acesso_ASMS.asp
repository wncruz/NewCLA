...
'objXmlDadosForm.save(Server.MapPath("../TesteConectividade-RealidadeIP.xml"))
		...
		Vetor_Campos(5)="adWChar,20,adParamInput, ASMS " 	
		Vetor_Campos(6)="adWChar,10,adParamInput, ATV " 
...
If objXmlDadosForm.parseError.errorCode < 1 Then
	...
	Call APENDA_PARAM("CLA_sp_ins_Aprovisionador",61,Vetor_Campos)
	'response.write APENDA_PARAMSTR("CLA_sp_ins_Aprovisionador2",58,Vetor_Campos)
	'response.end
