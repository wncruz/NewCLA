...
objNode = objXml.selectNodes("//CLA_RetornoTmp[@Msg_ID=164]")
var strAceite = new String("")
if (objNode.length > 0){
	strAceite = objNode[0].attributes[0].value
}
//-->
</SCRIPT>
...
<tr>
	<td align="center" height=25>
		...
		<input type="button" class="button" name="btnSair" value="Sair" onClick="javascript:window.returnValue=strAceite;window.close()" accesskey="X" onmouseover="showtip(this,event,'Sair (Alt+X)');">
	</td>
</tr>
</table>
</form>
