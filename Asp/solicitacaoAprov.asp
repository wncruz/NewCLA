...
Dim bbloqueiaSevPadrao

bbloqueiaSevPadrao = "false"
		...
		If Not objRSSolic.eof or Not objRSSolic.bof Then
			...
			'''if dblOriSolID = "10" then 
				...
				Else
					...
					if Trim(objRSCli("FAC_DES")) <> "Acesso simulado (SEV Padrão)" then
					...
					ELSE
						...
						bbloqueiaSevPadrao = "true"
				
					
						strEnd			= ""			'Nome do logradouro
						strComplEnd		= ""		'Complemento do logradouro
						strBairroEnd	= ""			'Bairro do logradouro
						strCepEnd		= ""		'CEP do logradouro
						
						strUFEnd		= "" 			'UF do logradouro
						strNroEnd		= ""			'Número do logradouro
						strLogrEnd		= ""			'Sigla do logradouro
						strEndCid		= ""					'Sigla da cidade do logradouro
						strEndCidDesc	= ""				'Decrição da cidade do logradouro
...
<table border=0 cellspacing="1" cellpadding="0" width="790">
		...
		<td colSpan=5>
		<table border=0 cellspacing="0" cellpadding="0" >
			<tr align=center class=clsSilver width="170px">
                                    <td> Sistema</>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
		...
		<td colspan=5 ><span id=spnVelServico>
		...
		<td colspan=5>
                            <table rules="groups" cellspacing="1" cellpadding="0" bordercolorlight="#003388" bordercolordark="#ffffff" width="80%">
						...
						<table cellspacing=1 cellpadding=0 border=0 width=790> 
								...
								<tr class=clsSilver>
										...
										<td width=321>Pabx Virtual:  	 <b> <%= TratarAspasJS(Trim(objRSCli("pabx_des"))) %>  </b> | Migração do Pabx Virtual:  	 <b> <%= TratarAspasJS(Trim(objRSCli("SEV_MIGRA_PABX"))) %>  </td> 
								  		...
								  		<table cellpadding=0 cellspacing=1 width=790  style="table-layout: fixed;"> 
                        <tr>
...
<input type=hidden name=hdnCNLCliente>
	...
	<!-- Good  Fim -->
				...
				<input type=radio name=rdoPropAcessoFisico  value="CLI" disabled="disabled" Index=2 onclick="EsconderTecnologia(0);ResgatarTecVel();">Cliente&nbsp;&nbsp;&nbsp;
...
Next
	...
	<tr class=clsSilver2>
		...
		<td width=170px nowrap><span id=spnOrigem>&nbsp;&nbsp;&nbsp;Sigla Estação Origem(CNL)</span></td>
			...
			<%if bbloqueiaSevPadrao ="false" then%>
			...
			<%else%>
				...
				<input type="text" class="text" name="txtCNLSiglaCentroCli"  maxlength="4"	size="8" onKeyUp="ValidarTipo(this,1)"	 onblur="CompletarCampo(this)" TIPO="A">
				&nbsp;Complemento
				<input type="text" class="text" name="txtComplSiglaCentroCli"  maxlength="6" size="10" onKeyUp="ValidarTipo(this,7)" onblur="CompletarCampo(this);ResgatarEstacaoOrigem(document.Form2.txtCNLSiglaCentroCli,document.Form2.txtComplSiglaCentroCli)" onchange="CompletarCampo(this);ResgatarEstacaoOrigem(document.Form2.txtCNLSiglaCentroCli,document.Form2.txtComplSiglaCentroCli)" TIPO="A">&nbsp;
			
				<!--<input type="text" class="text" name="txtComplSiglaCentroCli"  maxlength="6" size="10" onKeyUp="ValidarTipo(this,7)"  TIPO="A">&nbsp; -->
...
<table border=0 cellspacing="1" cellpadding="0" width="790" >
    ...
    <tr class="clsSilver">
        ...
        <input type="Hidden" name="cboLocalEntrega" id ="cboLocalEntrega">
		<td colspan="3"><input type="text" class="text" name="txtCNLLocalEntrega"  maxlength="4" size="6" onKeyUp="ValidarTipo(this,1)"	onblur="CompletarCampo(this);cboLocalEntrega.value=this;" TIPO="A">&nbsp;
    ...
    <tr class="clsSilver">
		...
		<td colspan="3"><input type="text" class="text" name="txtCNLLocalConfig"  maxlength="4" size="6" onKeyUp="ValidarTipo(this,1)"	onblur="CompletarCampo(this);cboLocalConfig.value=this;" TIPO="A">&nbsp;
