...
'	- Sistema			: CLA
'	- Arquivo			: ConfirmacaoRemFac.asp
'	- Responsável		: Vital
'	- Descrição			: Lista as facilidade que poderão ser removidas.
%>
<HTML>
<HEAD>
<TITLE>Confirmação de Remoção de Facilidades</TITLE>
...
for(var intIndex=0;intIndex<objNode.length;intIndex++){
	switch (parseInt(objNode[intIndex].attributes[1].value)){
		case 1:
			...
			switch (parseInt(objNode[intIndex].attributes[0].value)){
				case 0:
					strAtualiza += "<td align=center nowrap><img src='../imagens/tablex.gif' border=0 alt='A facilidade não foi encontrada. Facilidade não será removida.'></td>"
					break
				case 1:
					if (objNode[intIndex].attributes[10].value == 0){//Não esta sendo utilizada ACF_ID
						strAtualiza += "<td align=center><img src='../imagens/tableOk.gif' border=0 alt='A facilidade pode ser removida.'></td>"
						intAtualiza += 1
					}else{	
						strAtualiza += "<td align=center nowrap><img src='../imagens/table-.gif' border=0 alt='Facilidade esta sendo utilizada. Facilidade não será removida.'></td>"
					}	
					break
			}	
			strAtualiza += "</tr>"
		...
		case 2:
			...
			switch (parseInt(objNode[intIndex].attributes[0].value)){
				case 0:
					...
					break
				case 1:
					if (objNode[intIndex].attributes[4].value == 0){//Não esta sendo utilizada ACF_ID
						strAtualiza += "<td align=center><img src='../imagens/tableOk.gif' border=0 alt='A facilidade pode ser removida.'></td>"
						intAtualiza += 1
					}else{	
						strAtualiza += "<td align=center nowrap><img src='../imagens/table-.gif' border=0 alt='Facilidade esta sendo utilizada. Facilidade não será removida.'></td>"
		...
		case 3:
			...
			switch (parseInt(objNode[intIndex].attributes[0].value)){
				case 0:
					...
					break
				case 1:
					if (objNode[intIndex].attributes[7].value == 0){//Não esta sendo utilizada ACF_ID
						strAtualiza += "<td align=center><img src='../imagens/tableOk.gif' border=0 alt='A facilidade pode ser removida.'></td>"
						intAtualiza += 1
					}else{	
						strAtualiza += "<td align=center nowrap><img src='../imagens/table-.gif' border=0 alt='Facilidade esta sendo utilizada. Facilidade não será removida.'></td>"
		...
		case 999: //Interligacao
			...
			switch (parseInt(objNode[intIndex].attributes[0].value)){
				case 0:
					...
					break
				case 1:
					if (objNode[intIndex].attributes[8].value == 0){//Não esta sendo utilizada ACF_ID
						strAtualiza += "<td align=center><img src='../imagens/tableOk.gif' border=0 alt='A facilidade pode ser removida.'></td>"
						intAtualiza += 1
					}else{	
						strAtualiza += "<td align=center nowrap><img src='../imagens/table-.gif' border=0 alt='Facilidade esta sendo utilizada. Facilidade não será removida.'></td>"
...
<tr>
	...
	<td nowrap>
		A facilidade pode ser removida.
	</td>
</tr>
<tr>
	<td align="center" width=25>
	...
	<td>
		Facilidade esta sendo utilizada. Facilidade não será removida.
	</td>
</tr>
<tr>
	<td align="center" width=25>
		<img src="../imagens/tablex.gif" border=0>
	</td>
	<td nowrap>
		A facilidade não foi encontrada. Facilidade não será removida.
	</td>
</tr>
</table>	
