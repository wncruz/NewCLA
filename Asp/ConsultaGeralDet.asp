...
<Form name=Form1 method=Post action="facilidade.asp">
	...
	<input type=hidden name=dblRecId value="<%=Server.HTMLEncode(Request.Form("dblRecId"))%>">
	<input type=hidden name=id value="<%=Server.HTMLEncode(Request("id"))%>">
	<input type=hidden name=gla value="<%=Server.HTMLEncode(Request.Form("gla"))%>">
	<input type=hidden name=provedor value="<%=Server.HTMLEncode(Request.Form("provedor"))%>">
	<input type=hidden name=status value="<%=Server.HTMLEncode(Request.Form("status"))%>">
	<input type=hidden name=cboProvedor value="<%=Server.HTMLEncode(Request.Form("cboProvedor"))%>">
	<input type=hidden name=cboEstacao value="<%=Server.HTMLEncode(Request.Form("cboEstacao"))%>">
	<input type=hidden name=cboDominioNO value="<%=Server.HTMLEncode(Request.Form("cboDominioNO"))%>">
