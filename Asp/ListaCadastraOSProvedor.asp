...
'•ACCENTURE
'	- Sistema			: CLA
'	- Arquivo			: ListaCadastraOSProvedor.ASP
'	- Responsável		: Gustavo S. Reynaldo
'	- Descrição			: Listas dos Pedidos do provedor que não possuem OS cadastradas.
%>
...
Vetor_Campos(12)="adInteger,2,adParamInput,1"

strSql = APENDA_PARAMSTR("CLA_sp_sel_listaOSProvedor",12,Vetor_Campos)
...
if not objRSPag.Eof and not objRSPag.Bof then
	...
	strHtmlRet = ""
	strHtmlRet = strHtmlRet & "<table border=0 width=1505 cellspacing=1 cellpadding=1 >"
	strHtmlRet = strHtmlRet & "<th colspan=11>&nbsp;</th>"
	strHtmlRet = strHtmlRet & "<tr class=clsSilver>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center>Tipo de Processo</p></th>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center>UF</p></th>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center> Provedor</p></th>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center>Pedido</p></th>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center>Data Envio Carta</p></th>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center>Acesso Físico</p></th>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center>Cliente</p></th>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center>Dias Pendentes</p></th>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center>Vel Fis</p></th>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center>Numero de Acesso</p></th>"
	strHtmlRet = strHtmlRet & "<th nowrap ><p align=center> CNL</p></th>"
	...
	For intIndex = 1 to objRSPag.PageSize
		...
		strHtmlRet = strHtmlRet & "<td nowrap align=center>"& objRSPag("Pro_Nome") & "</td>"
		 strHtmlRet = strHtmlRet & "<td nowrap align=center><a href='javascript:AbrirCadastroOS(" & objRSPag("Acf_ID") & "," & objRSPag("Ped_ID") & "," & objRSPag("Pro_ID") & ");'><p align=center>" & objRSPag("Pedido") & "</a></td>"
