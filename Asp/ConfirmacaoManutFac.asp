...
'	- Responsável		: Vital
'	- Descrição			: Lista as facilidade que poderão ser atualizadas.
%>
<HTML>
<HEAD>
<TITLE>Confirmação de Alteração de Facilidades</TITLE>
	...
	switch (parseInt(objNode[intIndex].attributes[1].value)){
		case 1:
			...
			switch (parseInt(objNode[intIndex].attributes[0].value)){
				case -1:
					strAtualiza += "<td align=center nowrap><img src='../imagens/tablex.gif' border=0 alt='A facilidade não foi encontrada. Facilidade não será atualizada.'></td>"
					break
				case 0:	
					strAtualiza += "<td align=center><img src='../imagens/tableOk.gif' border=0 alt='A facilidade pode ser atualizada.'></td>"
					intAtualiza += 1
					break
				case 1:
					strAtualiza += "<td align=center nowrap><img src='../imagens/table-.gif' border=0 alt='Já existe uma facilidade cadastrada essa caracteristica. Serão atualizados somente os dados não obrigatórios.'></td>"
					intAtualiza += 1
					break
			}	
			strAtualiza += "</tr>"
...
<tr>
	...
	<td>
		Já existe uma facilidade com as novas caracteristicas. Serão atualizados somente os dados não obrigatórios.
	</td>
</tr>
<tr>
	<td align="center" width=25>
	...
	<td nowrap>
		A facilidade não foi encontrada. Facilidade não será atualizada.
	</td>
</tr>
</table>	
