...
Sub Com_CreatValidCode(pSN) 
    ...
    Const cOdds = 1 ' Diversos ponto probabilidade 
    Const cAmount = 13 ' O número de texto 
    Const cCode = "0123456789+=?" 

    ' Cor dados (caracteres, background) 
    Dim vColorData(1),vColorRandom(10) 
    'vColorData(0) = ChrB(Int(Rnd*155)+100) & ChrB(Int(Rnd*155)+100) & ChrB(Int(Rnd*155)+100) 
    ...
    vCode(5) = 11 
    vCode(6) = 12 
    Session(pSN) = vCode(0)*10+vCode(1)+vCode(3)*10+vCode(4) 
