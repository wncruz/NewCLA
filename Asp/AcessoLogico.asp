...
if Trim(Server.HTMLEncode(Request("acao"))) = "" then
...
<tr>
	<td colspan=2 align="center" height=30px >
		...
		<%
		Select Case Trim(Ucase(Server.HTMLEncode(Request("acao"))))
			Case "ALT"
...
<tr>
	<% if Trim(Ucase(Server.HTMLEncode(Request("acao"))))  <> "CAN" and Trim(Ucase(Server.HTMLEncode(Request("acao"))))  <> "DES" then %>
	<th width=24px></th>
	<%end if %>
