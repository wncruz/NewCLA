...
If objXmlDadosForm.parseError.errorCode < 1 Then
	...
	'ASMS:
	Vetor_Campos(50)="adWChar,10,adParamInput,"& Id_Logico_Temp
	Vetor_Campos(51)="adWChar,1,adParamInput,"& Indicador_Alterar
	Vetor_Campos(52)="adWChar,50,adParamInput,"& Id_Servico
	Vetor_Campos(53)="adWChar,10,adParamInput,"& Velocidade_Total
	
	Vetor_Campos(54)="adWChar,4000,adParamInput,"& Header_Original
	Vetor_Campos(55)="adWChar,3000,adParamInput,"& External_Reflist
	
	Vetor_Campos(56)="adWChar,50,adParamInput,"& Id_Acesso
	
	Vetor_Campos(57)="adInteger,2,adParamOutput,0"
	Vetor_Campos(58)="adWChar,100,adParamOutput,a "
	
	Call APENDA_PARAM("CLA_sp_ins_Aprovisionador3",58,Vetor_Campos)
