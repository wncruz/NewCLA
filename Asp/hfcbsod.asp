...
DIM   strXML
	...
	strXML = strXML & "<arquivo>HFCBSoD</arquivo>"
...
'	END IF
	...
	if not objRSFac.eof then 
		do While not objRSFac.Eof 
			...
			'strTipoPorta = objRSFac("Fac_TipoPorta")
	...
	strXML = strXML & "<svlan>"& strSVlan &"</svlan>"	
	strXML = strXML & "<pe>"& strPe &"</pe>"
	strXML = strXML & "<porta>"& strPorta &"</porta>"
	strXML = strXML & "<tipoporta>"& strTipoPorta &"</tipoporta>"
