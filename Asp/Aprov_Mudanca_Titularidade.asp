...
If objXmlDadosForm.parseError.errorCode < 1 Then
	...
	Cli_CC = trim(objXmlDadosForm.selectSingleNode("//cliente/conta").text)
	Cli_SubCC = trim(objXmlDadosForm.selectSingleNode("//cliente/subconta").text)
	Cli_Nome = trim(objXmlDadosForm.selectSingleNode("//cliente/razao-social").text)
	Cli_NomeFantasia = trim(objXmlDadosForm.selectSingleNode("//cliente/nome-fantasia").text)
	...
	Call APENDA_PARAM("CLA_sp_upd_MudancaTitularidadeAprov",15,Vetor_Campos)
