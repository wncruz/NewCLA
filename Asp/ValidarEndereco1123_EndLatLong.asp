		...
		'if CEP <> "" then
			...
			'While Not objRS.Eof
			    ''''-----'''''
						...
						Strxml1 = Strxml1 & 	"	  <ns0:ind_solic_valida_endereco>2</ns0:ind_solic_valida_endereco> " & vbnewline
						Strxml1 = Strxml1 & 	"	  <ns0:ind_solic_ajuste_escrita>2</ns0:ind_solic_ajuste_escrita> " & vbnewline
