	...
	<head>
		...
		if (document.getElementById("cboTpAprovacao").value == "2")
		  { 
			...
			target = "_self"
			action = "IncluirAutorizarAcesso.asp?tp=1"
			submit()
			}
		  }
		}
	...
	<body>
		<form method="post" name=Form1 >
			...
			<table border=0 cellspacing="1" cellpadding = 0 width="760" >
				<tr class=clsSilver>
					<th colspan=2><p align=center>Cadastro de Senhas</p></th>
				</tr>
				<tr>
				...
				<tr class=clsSilver>
					...
					<td>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" class="button" name="btnProcurar" value="Procurar" disabled="disabled" accesskey="P" onMouseOver="showtip(this,event,'Procurar (Alt+P)');" style="width:100px" onClick="ProcurarSenha()">
					</td>
				</tr>
				<tr class=clsSilver>
			...
			<table border="0" cellspacing="1" cellpadding="0" width="760">
				...
				<tr>
					<td align="center" height=30px>
						<input type="button" class="button" name="btnIncluir" value="Incluir" style="width:100px" accesskey="I" onMouseOver="showtip(this,event,'Incluir (Alt+I)');" onClick="IncluirSenha()">&nbsp;
						<input type="button" class="button" name="btnExcluir" disabled="disabled" value="Excluir" style="width:100px" accesskey="E" onMouseOver="showtip(this,event,'Excluir (Alt+E)');" onClick="ExcluirSenha()">&nbsp;
