...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<html>
			...
			<TABLE align="center" border="1" cellPadding="0" cellSpacing="0" width = "100%">
				<TR>
					<TD CLASS="TD_CAMPO_CLARO" align="middle">Observações</TD>
				...
				<TR>
					...
					<TD CLASS="TD_CAMPO_CLARO" align="middle" width="70%">
						<span style= "FONT-WEIGHT: normal">
							<font color = "white">.</font><xsl:value-of select="//observaçãos"/><br/><font color = "white">.</font><xsl:value-of select="//observaçãop"/></span>
					</TD>
				</TR>
<!-- LP -->								
			</TABLE>
