...
<!--												<TD class="td_resposta" style = "width:310px;height:70px;TEXT-ALIGN:center" valign= "center"><font color = "white">.</font><xsl:value-of select="//telemar/obs"/></TD> -->
												<TD class="td_resposta" style = "width:310px;height:70px;TEXT-ALIGN:center" valign= "center"><font color = "white">.</font><xsl:value-of select="//observaçãos"/><br/><font color = "white">.</font><xsl:value-of select="//observaçãop"/></TD>
											</TR>
										</TABLE>	
<!-- LP -->
									</TD>
