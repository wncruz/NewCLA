	...
	<xsl:template match="/">
		<html>
			...
			<TABLE align="center" border = "0"  cellPadding="0" cellSpacing="1" width = "100%">
				<TR>
					...
					<TD ROWSPAN = "3" VALIGN = "CENTER" ALIGN = "CENTER" STYLE = "FONT-SIZE:10PT" width ="40%" CLASS = "TD_RESPOSTA">
						<B>PEDIDO DE ACESSO DIVEO DO BRASIL </B>
					</TD>
			...
			<TABLE align="center" border="0" cellPadding="0" cellSpacing="0" width = "100%">
				<TR>
					<TD width = "30%"><B>NÚMERO DO ACESSO: <xsl:value-of select="//pontaebt"/> </B></TD>
				</TR>
			</TABLE>
			<BR></BR>
			<BR></BR>
			...
			<TBODY>
				<TR>
					<TD class="TD_RESPOSTA" width="16%"><B>Velocidade</B></TD>
					<TD class="TD_RESPOSTA" width="16%"><FONT color="white">.</FONT>  <xsl:value-of select="//clientevelocidade"/> </TD>
					<TD class="TD_RESPOSTA" width="16%"><B>Valor Instalação</B></TD>
					<TD class="TD_RESPOSTA" width="16%"><FONT color="white">.</FONT></TD>
					<TD class="TD_RESPOSTA" width="16%"><B>Valor Mensalidade</B></TD>
					<TD class="TD_RESPOSTA" width="16%"><FONT color="white">.</FONT></TD>
				</TR>
			</TBODY>
			</TABLE>
			...
			<TABLE align="center" border="0" cellPadding="0" cellSpacing="1" width = "100%">
				...
				<TR>
					...
					<TD CLASS = "TD_CAMPO_CLARO" COLSPAN = "3"> CÓDIGO TRIBUTÁRIO </TD>
			...
			<TABLE align="center" border="0" cellPadding="0" cellSpacing="1" width = "100%">
				...
				<TR>
					<TD CLASS = "TD_CAMPO_CLARO"  width = "20%" > CÓDIGO TRIBUTÁRIO </TD>
					<TD  CLASS = "TD_RESPOSTA" COLSPAN = "5"> <font color = "white">.</font> </TD>
				</TR>
			</TABLE>
			<BR></BR>
			<BR></BR>
        	...
        	<TABLE cellSpacing="1" cellPadding="0" width="100%" align="center" border="0">
          	<TBODY>
	          	<TR>
	            		<TD class="TD_CAMPO" align="middle" width="15%" rowSpan="4">Autorização do Serviço </TD>
