		...
		<td>
			<table width="98%" align="center">
				...
				<tr>
					...
					<td ><xsl:value-of select="//pontaAcontato"/></td>
					<td class="campo">Tel:</td>
					<td ><xsl:value-of select="//pontaAtelefone"/></td>
				</tr>
				<tr>
					<td class="campo" >E-Mail para Contato:</td>
					<td  colspan="3">
			...
			<table style="border:solid 2px black" width="90%" align="center" >
				...
				<tr>
					...
					<td  colspan="3">
						...
						<font color = "white">.</font><xsl:value-of select="//interfacepontaA"/>
					</td>
		...
		<td>
			<TABLE width="100%">
				...
				<TR>
					<TD></TD>
					<TD></TD>
					<TD ><span class="campo"> Rede:</span> SDH/PDH</TD>
					<TD></TD>
					<TD  colspan="2">
	...
	<tr>
		<td>
			...
			<table style="border:solid 2px black" width="80%" align="center">
				<tr>
					<td class="observacao" HEIGHT="50PX"><font color = "white">.</font><xsl:value-of select="//observacaop"/><br/><font color = "white">.</font><xsl:value-of select="//observacaos"/></td>
				</tr>
			</table>
		</td>
	</tr>
