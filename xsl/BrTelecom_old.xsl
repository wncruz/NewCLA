...
<TABLE cellSpacing="1" cellPadding="0" width="95%" align="center" bgColor="#111111" border="0">
  ...
  <TR>
		...
		<TD class="TD_NEGRITO">UF: <FONT size="2"><FONT color="white">.</FONT><B><xsl:value-of select="//ufcontratada"/></B></FONT></TD>
  </TR>

  <TR>
		<TD class="TD_NEGRITO" vAlign="top" colSpan="4">CONTRATO:<BR></BR><FONT size="2" align="center"><B> (x)EILD </B> </FONT></TD>
  </TR>
  ...
  <TR>
    <TD class="TD_NEGRITO" vAlign="top" colSpan="2" rowSpan="2">
		...
		<FONT color="white">.</FONT>
		(<B>x</B>) <FONT size="2" align="center"> <B> SÍNCRONO </B> </FONT> <FONT color="white">....</FONT>
  ...
  <TR>
    <TD class="TD_NEGRITO" vAlign="top" colSpan="3" rowSpan="2">18.OBSERVAÇÕES<BR></BR>
		<FONT color="white">.</FONT>
		<FONT size="2" align="center"> <B> <xsl:value-of select="//observaçãop"/> </B> </FONT>
	</TD>
  ...
  <TR>
    <TD class="TD_NEGRITO" vAlign="top" colSpan="3">
		...
		<FONT size="2" align="center"> 
		<B>
			<xsl:value-of select="//facilidade"/>  
		</B>	
		</FONT>
