				...
				<TABLE align="center" cellPadding="0" cellSpacing="0" width="80%" style = "border-top: 1px solid ;border-right: 1px solid ;border-bottom: 1px solid ;border-left: 1px solid ;">
					...
					<TR>
						<TD>
							<TABLE BORDER = "0">
								<TR>
									<TD ROWSPAN = "2" ALIGN = "MIDDLE" CLASS = "TD_TELEMAR"> FO EtherNET  </TD>
					...
					<TR>
						<TD>
							...
							<xsl:for-each select="//solicitacao/Combo">          
								<TABLE>
									<TR>									
										<TD>Ação </TD>
										<TD class="td_resposta"  style = "width=250px" ><font color = "white">.</font><xsl:value-of select="strServico"/></TD>
										<TD>Serviço </TD>
										<TD class="td_resposta"  style = "width=250px" ><font color = "white">.</font><xsl:value-of select="serviço"/></TD>
										<TD>Data </TD>
								...
								<TABLE>
									<TR>
										...
										<TD class="td_resposta"><font color = "white">.</font><xsl:value-of select="DesignacaoServico"/></TD>
										<TD></TD>
										<TD>Velocidade</TD>
										<TD class="td_resposta"><font color = "white">.</font><xsl:value-of select="DescVelAcessoLog"/></TD>
									</TR>
								</TABLE>
							</xsl:for-each>
						</TD>
					...
					<TR>
						<TD class = "td_titulo">OBSERVAÇÕES SAIP</TD>
					</TR>
							...
							<TABLE>
								<TR>
									<TD VALIGN = "TOP" STYLE = "BORDER-RIGHT: thin solid; BORDER-TOP: thin solid;BORDER-LEFT: thin solid;BORDER-BOTTOM: thin solid;">
										<TABLE width="750">											
											<TR>
												<TD class="td_resposta" style = "width:940px;height:25px;TEXT-ALIGN:center" valign= "center"><font color = "white">.</font><xsl:value-of select="//telemar/observacaoSaip"/></TD>
											</TR>											
										</TABLE>	
									</TD>
								</TR>
