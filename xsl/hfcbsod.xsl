				...
				<TABLE align="center" cellPadding="0" cellSpacing="0" width="80%" style = "border-top: 1px solid ;border-right: 1px solid ;border-bottom: 1px solid ;border-left: 1px solid ;">
					...
					<TR>
						<TD>
							<TABLE BORDER = "0">
								<TR>
									<TD ROWSPAN = "2" ALIGN = "MIDDLE" CLASS = "TD_TELEMAR"> HFC BSoD  </TD>
					...
					<TR>
						<TD>
							<TABLE>
								<TR>
									<TD NOWRAP = "true">Endereço da PONTA HFC BSoD</TD> 
					...
					<TR>
						<TD>		
							<TABLE width = "100%"> 
								<TR>		
									<TD> Designação (Nº contrato HFC BSoD) </TD>
									...
									<TR>						
									<TD nowrap = "true">SVLAN</TD>
									<TD class="td_resposta"><font color = "white">.</font><xsl:value-of select="//tecnico/svlan"/></TD>																						
									<TD nowrap = "true">PE</TD>
									<TD class="td_resposta"><font color = "white">.</font><xsl:value-of select="//tecnico/pe"/></TD>								
									<TD nowrap = "true">Porta</TD>
									<TD class="td_resposta"><font color = "white">.</font><xsl:value-of select="//tecnico/porta"/></TD>
									<TD nowrap = "true">Tipo Porta</TD>
									<TD class="td_resposta"><font color = "white">.</font><xsl:value-of select="//tecnico/tipoporta"/></TD>													
