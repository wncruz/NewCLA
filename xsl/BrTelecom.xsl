...
<TABLE cellSpacing="1" cellPadding="0" width="95%" align="center" bgColor="#111111" border="0">
  ...
  <TR>
		<TD class="TD_NEGRITO" vAlign="top" colSpan="2">CONTRATO:<BR></BR></TD>
  ...
  <TR>
    <TD class="TD_NEGRITO" vAlign="top" colSpan="4">
		13.INTERFACE FISICA - PONTA B: <BR></BR>
		<FONT color="white">.</FONT>
		<FONT size="2" align="center"> <B> <xsl:value-of select="//clienteinterface"/> </B></FONT>
	</TD>
  </TR>
  ...
  <TR>
    ...
    <p><FONT color="white">.</FONT>Esta solicitação é regida pelo novo Regulamento de EILD, aprovado pela Res. 590/2012, de 18/05/2012.</p>
		<FONT color="white">.</FONT>
		<FONT size="2" align="center"> <B> <xsl:value-of select="//observacaos"/> <BR/><xsl:value-of select="//observacaop"/></B> </FONT>
	</TD>
