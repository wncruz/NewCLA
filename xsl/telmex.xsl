	...
	<xsl:template match="/">
		<html>
			...
			<TABLE align="center" cellPadding="0" border = "0" cellSpacing="1" width = "100%">
				<TR  >
					<TD CLASS = "TD_CAMPO" width = "20%" STYLE = "FONT-SIZE:10PT" >AÇÃO</TD>
					<TD   width = "30%" CLASS = "TD_RESPOSTA" STYLE = "FONT-SIZE:10PT" ><font color = "white">.</font> <xsl:value-of select="//acao"/></TD>
					<TD CLASS = "TD_CAMPO_CLARO" width = "20%" STYLE = "FONT-SIZE:10PT" > Nº ACESSO </TD>
					<TD  width = "30%" CLASS = "TD_RESPOSTA" STYLE = "FONT-SIZE:10PT" > <font color = "white">.</font><xsl:value-of select="//pontaebt"/></TD>
				</TR>
			</TABLE>
			...
			<TABLE align="center" border="0" cellPadding="0" cellSpacing="0" width = "100%">
				<TR>
					...
					<TD >
						(	
						<xsl:if test="//chkdesativa = -1">
							<span style = "font-family:'verdana'"><B>x</B></span>
						</xsl:if>
						)
						Desativação   Para:   <xsl:value-of select="//dtdesativa"/>
					</TD>
				</TR>
				<TR>
					<TD >
			...
			<TABLE align="center" border="0" cellPadding="0" cellSpacing="0" width = "100%">
				<TR>
					<TD width = "30%" valign = "top"><B>Prazo de Vigência do Acesso: </B></TD>
					<TD>
						<TABLE align="center" border="0" cellPadding="0" cellSpacing="0" width = "100%">
						<TR>
							<TD >
			...
			<TABLE align="center" border="0" cellPadding="0" cellSpacing="1" width = "100%">
				<TR>
					<TD CLASS = "TD_CAMPO"  width = "15%" rowspan = "4" align = "center"> Pedido de Viabilidade  </TD>
					<TD CLASS = "TD_CAMPO_CLARO" colspan = "2" align = "center"> Representante da Embratel </TD>
					<TD CLASS = "TD_CAMPO_CLARO" colspan = "2" align = "center"> Representante da Contratada </TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD CLASS = "TD_RESPOSTA"  > <font color = "white">.</font> <xsl:value-of select="//localdataebt"/> </TD>
					<TD CLASS = "TD_RESPOSTA"  > Local/Data </TD>
			...
			<TABLE align="center" border="0" cellPadding="0" cellSpacing="1" width = "100%">
				<TR>
					<TD CLASS = "TD_CAMPO"  width = "15%" rowspan = "5" align = "center"> Pedido de Viabilidade </TD>
					<TD CLASS = "TD_CAMPO_CLARO" colspan = "2" align = "left"><B>OK:</B> ( )(s/n)</TD>
					<TD CLASS = "TD_CAMPO_CLARO" colspan = "2" align = "left"> Prazo de Atendimento:       (dias) </TD>
				</TR>
				<TR>
					<TD CLASS = "TD_CAMPO_CLARO" colspan = "2" align = "center"> Representante da Embratel </TD>
					<TD CLASS = "TD_CAMPO_CLARO" colspan = "2" align = "center"> Representante da Contratada </TD>
			...
			<TABLE align="center" border="0" cellPadding="0" cellSpacing="0" width = "100%">
				<TR>
					<TD width = "30%"><B>Tipo de Acesso: </B></TD>
					<TD >

						(	
						<xsl:if test="//chktecfibra = -1">
							<span style = "font-family:'verdana'"><B>x</B></span>
						</xsl:if>
						)
						Fibra
			...
			<TABLE align="center" border="0" cellPadding="0" cellSpacing="1" width = "100%">
				<TR>
					<TD CLASS = "TD_CAMPO"  width = "15%" rowspan = "4" align = "center"> Data Prevista de Entrega:</TD>
					<TD CLASS = "TD_CAMPO_CLARO" colspan = "2" align = "center"> Representante da Embratel </TD>
					<TD CLASS = "TD_CAMPO_CLARO" colspan = "2" align = "center"> Representante da Contratada </TD>
				</TR>
				<TR>
			...
			<TABLE align="center" border="0" cellPadding="0" cellSpacing="1" width = "100%">
				<TR>
					...
					<TD CLASS = "TD_RESPOSTA"  width= "80%" height="50px"  STYLE = "height:80px" valign = "top">
						<span style= "FONT-WEIGHT:normal"><font color = "white">.</font><xsl:value-of select="//observação"/></span>
					</TD>
				</TR>
			</TABLE>
			<BR></BR>
