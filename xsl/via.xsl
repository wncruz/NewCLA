				...
				<TABLE align="center" cellPadding="0" cellSpacing="0" width="80%" style = "border-top: 1px solid ;border-right: 1px solid ;border-bottom: 1px solid ;border-left: 1px solid ;">
					...
					<TR>
						<TD>
							<TABLE BORDER = "0">
								<TR>
									<TD ROWSPAN = "2" ALIGN = "MIDDLE" CLASS = "TD_TELEMAR"> VIA  </TD>
					...
					<TR>
						<TD>
							<TABLE>
								<TR>
									<TD NOWRAP = "true">Endereço da PONTA VIA</TD> 
					...
					<TR>
						<TD>		
							<TABLE> 
								<TR>		
									<TD> Designação (Nº contrato VIA) </TD>
									<TD class="td_resposta"><font color = "white">.</font><xsl:value-of select="//tecnico/designacao"/></TD>
								</TR>
									<TR>
									<TD nowrap = "true">Nome do Link</TD>
									<TD class="td_resposta"><font color = "white">.</font><xsl:value-of select="//tecnico/link"/></TD>
									<TD nowrap = "true">VLAN</TD>
