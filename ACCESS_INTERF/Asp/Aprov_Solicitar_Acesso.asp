...
'**********	
	...
	If ( Trim(Acao) = "ATV"  or Trim(Acao) = "ALT"  or Trim(Acao) = "DES" ) Then
		...
		'Serviço/Order Entry
		 ...
		 rede_wireless          = trim(objXmlDadosForm.selectSingleNode("/requisicao-cla/servico/order-entry/rede_wireless").text)
	...
	if ( OriSol_Descricao = "SGAV"  ) then
		...
		PABX_VIRTUAL_MIGRACAO = trim(objXmlDadosForm.selectSingleNode("/requisicao-cla/servico/order-entry/pabx_virtual_plataforma_migracao").text)
		TECNOLOGIA_IP = trim(objXmlDadosForm.selectSingleNode("/requisicao-cla/servico/order-entry/tecnologia-ip").text)
		
		if (PABX_VIRTUAL_MIGRACAO = "S") then
			MUD_CADASTRAL = trim(objXmlDadosForm.selectSingleNode("/requisicao-cla/servico/order-entry/mudCadastral").text)
		end if
	...
	Vetor_Campos(65)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(66)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(67)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(68)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(69)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(70)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(71)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(72)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(73)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(74)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(75)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(76)="adWChar,10,adParamInput,NULL"
	Vetor_Campos(77)="adWChar,10,adParamInput,NULL"
	
	Vetor_Campos(78)="adWChar,10,adParamInput,"& PABX_VIRTUAL_MIGRACAO
	
	Vetor_Campos(79)="adWChar,10,adParamInput,"& TECNOLOGIA_IP
	
	Vetor_Campos(80)="adWChar,10,adParamInput,"& MUD_CADASTRAL
	
	Vetor_Campos(81)="adWChar,10,adParamInput,"& rede_wireless
	
	Call APENDA_PARAM("CLA_sp_ins_Aprovisionador",81,Vetor_Campos)
