...
'	- Sistema			: CLA
'	- Arquivo			: Consulta1298.asp
'	- Descrição			: Detalhe de uma solicitação


dblSolId = Trim(Request.QueryString("SOLID"))
...
Set objRS = db.execute("select max(sol.sol_id) as sol_id from CLA_Solicitacao sol where Acl_IDAcessoLogico = (select Acl_IDAcessoLogico from CLA_Solicitacao where sol_id = " & dblSolId & ")" )
if Not objRS.Eof  and  Not objRS.bof then
	 dblSolId = objRS("sol_id")
End if


Response.Write "<script language=javascript>alert('dblSolId= '"  & dblSolId & "');</script>"
	Response.End
...
<table  cellspacing="1" cellpadding="1"  width="760" border=0 >
	...
	<tr>
		<th colspan="4" >&nbsp;•&nbsp;Informações do Cliente</td>
	</tr>
	<tr class=clsSilver>
	...
	<% IF strOrigemSol = "10" THEN %>
		<tr class=clsSilver>
		  ...
		  <td colSpan=3>&nbsp;<%=strIA%> </td>
		</tr>
	<%END IF %>
	<tr class=clsSilver>
		<td width=170>Serviço</td>
		<td >&nbsp;<%=strServicoPedido%> <%IF strPabx_Virtual <> "" then %><br><br>PABX VIRTUAL BROADSOFT: <%= strPabx_Virtual %><br><%END IF%></td>
	...
	<tr class="clsSilver">
		...
		<td colspan="3">
		    &nbsp;<%if strAntAcesso = "S" then%>Sim<%else%>Não<%end if%>
		</td>
	</tr>
	<tr class=clsSilver>
	...
	<tr class=clsSilver>
		<td width=170>Resposta <br>Indicada no SSA</td>
		<td colspan="3" valign=top>&nbsp;</td>
	</tr>
	<tr >
		<th colspan=4 >&nbsp;•&nbsp;Datas</td>
	</tr>
	<!--
	<tr class=clsSilver>
	...
	While not objRSFis.EOF
		...
		%>
			...
			<tr class=clsSilver>
				...
				<td >&nbsp;<%set objRS = db.execute("CLA_sp_sel_newconsultaTecnologiaFacilidade " & dblSolId )
					While not objRS.Eof
			...
			%>
				...
				<tr class="clsSilver">
					...
					<td>&nbsp;<%=strNroAcesso%></td>
                                ...
                                <!--MSCAPRI - CH-97014NBU -->
				<tr class="clsSilver">
					<td class="clsSilver2" colspan="4">&nbsp;•&nbsp;Datas do Acesso Físico - Acesso <%=intIndex%></th>
				</tr>
				<tr class=clsSilver>
...
<table border=0 cellspacing="1" cellpadding="0" width="760"> 
	...
	<tr>
		<th colspan=4>&nbsp;•&nbsp;Coordenação Embratel
		</td>
	</tr>
<!--
	<tr class=clsSilver>
...
<table border=0 cellspacing=1 cellpadding=0  width=760>
	<tr><th colspan="4" >&nbsp;Facilidades do Serviço</th></tr>
</table>
...
<table border=0 cellspacing=1 cellpadding=0  width=760>
	<tr><th colspan="4" >&nbsp;•&nbsp;Facilidades</th></tr>
</table>
