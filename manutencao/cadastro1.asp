...
<body>
<%if usuario = "PRSS" OR  usuario = "PRSSILV" OR usuario = "EDAR" OR usuario = "FEMAG" OR usuario = "LUANAVB" THEN %>
<form action="cadastro.asp" method="post" name="frm_sql" id="frm_sql">
<h2>Operação:</h2>
