...
function AssociarLogico() {
  with (document.forms[0]) {
    if (txtNroLogico.value != "") {
      ...
      alert("Informe o n�mero do Acesso L�gico.");
      txtNroLogico.focus();
      return;
    }
  }
...
function CheckSevMestra() {
  ...
  if (
    (document.getElementById("cboProvedor").value == "136" &&
      (document.getElementById("strAcessoTipoRede").value == null ||
        document.getElementById("strAcessoTipoRede").value != "4")) ||
    document.getElementById("cboProvedor").value == "137"
  ) {
    alert(
      "Est�o bloqueadas novas ativa��es para provedores \nHFC BSoD VIA e HFC BSoD NET. \nEm caso de d�vidas, contatar a equipe do SOE."
    );
    return;
  }
  ...
  if (document.forms[0].cboOrigemSol.value == "9") {
    if (
      document.getElementById("cboProvedor").value == "145" ||
      document.getElementById("cboTecnologia").value == "7"
    ) {
      ...
      if (
        scboInterFaceEnd != "GIGABIT ETHERNET E" &&
        scboInterFaceEnd != "GIGABIT ETHERNET O" &&
        scboInterFaceEnd != "FAST ETHERNET E" &&
        scboInterFaceEnd != "FAST ETHERNET O"
      ) {
        alert(
          "Informar Interface V�lida. Op��es: \n\n - FAST ETHERNET E \n - FAST ETHERNET O \n - GIGABIT ETHERNET E \n - GIGABIT ETHERNET O."
        );
      ...
      if (
        scboInterFaceEndFis != "GIGABIT ETHERNET E" &&
        scboInterFaceEndFis != "GIGABIT ETHERNET O" &&
        scboInterFaceEndFis != "FAST ETHERNET E" &&
        scboInterFaceEndFis != "FAST ETHERNET O"
      ) {
        alert(
          "Informar Interface V�lida. Op��es: \n\n - FAST ETHERNET E \n - FAST ETHERNET O \n - GIGABIT ETHERNET E \n - GIGABIT ETHERNET O."
        );
    ...
    if (document.getElementById("cboTecnologia").value == "5") {
      ...
      if (scboInterFaceEnd != "VDSL") {
        alert("Informar Interface V�lida. Op��es: \n\n - VDSL.");
        document.getElementById("cboInterFaceEnd").focus();
        return;
      }
...
function ReanaliseSEV() {
  with (document.forms[0]) {
    ...
    var intRet = alertbox(
      "Deseja realmente solicitar a Rean�lise da SEV ?",
      "Sim",
      "N�o",
      "Sair"
    );
  ...
  with (document.forms[0]) {
    ...
    if (cboOrigemSol.value != "3" && cboOrigemSol.value != "9") {
      ...
      if (
        ...
        alert(
          "Somente s�o permitidos os sistemas APG, SGA VOZ VIP'S e SGA PLUS para Origem Solicita��o 'POVOAMENTO'."
        );
    ...
    if (hdnstrPOP.value == "0" && cboSistemaOrderEntry.value == "SGA PLUS") {
      alert(
        "Desculpe, voc� n�o tem permiss�o para criar POVOAMENTO do sistema SGA PLUS. \nFavor, solicite ao seu Gestor que efetue a solicita��o de acesso via sistema GATI."
      );
      cboSistemaOrderEntry.value = "";
      cboOrigemSol.focus();
      return;
    ...
    if (
      ...
      alert(
        "Desculpe, voc� n�o tem permiss�o para criar POVOAMENTO do sistema SGA VOZ VIP'S. \nFavor, solicite ao seu Gestor que efetue a solicita��o de acesso via sistema GATI."
      );
      cboSistemaOrderEntry.value = "";
      cboOrigemSol.focus();
      return;
...
function ResgatarPromocaoRegime(obj) {
  with (document.forms[1]) {
    ...
    //Altera��o Aline
    //Data 27/09/2006
    //Descri��o: para n�o deixar selecionar no combro de provedor , quando o pr�pietario � terceiro ou cliente
    if (strValue != "") {
      if (strValue == "11") {
        //if ((rdoPropAcessoFisico[0].checked) ||  (rdoPropAcessoFisico[2].checked))
        if (rdoPropAcessoFisico[0].checked) {
          alert(
            "N�o � poss�vel selecionar EMBRATEL para tipo Terceiro/Cliente"
          );
          obj.value = 0;
          strValue = 0;
        }
          ...
          if (objAry.length > 0) {
            switch (objAry[0].toUpperCase()) {
              ...
              case "VMM":
                ...
                break;
              default:
                alert("Tipo de Contrato Inv�lido(VES/VEM/VMM).");
                obj.value = "";
                return false;
            }
          }
...
function Gravar() {
  //Verifica se h� solicita��o j� criada para o Aprov-ID (�s vezes o usu�rio clica mais de uma vez no bot�o gravar, gerando duplicidade de solicita��o.

  if (document.forms[1].strOrigemAPG.value == "Aprov") {
    //Somente para solicita��es vindas dos Aprovisionadores
    if (
  ...
  if (objNode.length == 0) {
    alert(
      "� obrigat�rio ADICIONAR pelo menos um acesso f�sico, antes da grava��o da solicita��o."
    );
    return;
  }
  ...
  if (getCheckedValue(document.Form2.rdoPropAcessoFisico) != "") {
    alert(
      "A grava��o da solicita��o n�o poder� ser efetuada enquanto a �rea 'Informa��es do Acesso' estiver preenchida. Apague as INFORMA��ES do ACESSO, clicando em LIMPAR."
    );
    return;
  }
...
*/
    ...
    //{
    //if (VerificaPropAcesso('TER')) //Retirado para obrigar EBT tamb�m.
    //{
    ...
    if (txtDesigAcessoPri.value != "" && txtDesigAcessoPri.value.length == 7) {
      hdnDesigAcessoPri.value =
        txtDesigAcessoPri0.value + txtDesigAcessoPri.value;
    }

    if (!ValidarTipoInfo(txtDtIniTemp, 1, "Data In�cio Tempor�rio")) return;
    if (!ValidarTipoInfo(txtDtFimTemp, 1, "Data Fim Tempor�rio")) return;
    if (!ValidarTipoInfo(txtDtDevolucao, 1, "Data Devolu��o Tempor�rio"))
      return;
    if (
      !ValidarCampos(
        txtDtEntrAcesServ,
        "Data Desejada de Entrega do Acesso ao Servi�o"
      )
    )
      return;
    if (
    ...
    if (
      !ValidarTipoInfo(
        txtDtPrevEntrAcesProv,
        1,
        "Data Prevista de Entrega do Acesso pelo Provedor"
      )
    )
      return;
  }
...
function ContinuarGravacao() {
  ...
  with (document.forms[1]) {
    ...
    if (document.Form2.hdnstrAcessoTipoRede.value == "10") {
      ...
      if (!blnProvedor) {
        alert("� obrigat�rio a solicita��o do acesso f�sico BSOD LIGHT.");
        return;
      }
    }
  }
  ...
  with (document.forms[2]) {
    ...
    if (IsEmpty(hdntxtGICL.value)) {
      alert("GIC-L � um campo obrigat�rio.");
      return;
    }
    if (document.forms[1].strOrigemAPG.value == "Aprov") {
      if (!ValidarCampos(cboLocalEntrega, "Esta��o do Local de Entrega"))
        return;
      if (!ValidarCampos(cboLocalConfig, "Esta��o do Local de Configura��o"))
        return;
    } else {
      if (!ValidarCampos(txtCNLLocalEntrega, "Esta��o do Local de Entrega"))
        return;
      if (!ValidarCampos(txtComplLocalEntrega, "Esta��o do Local de Entrega"))
        return;
      if (!ValidarCampos(txtCNLLocalConfig, "Esta��o do Local de Configura��o"))
        return;
      if (
        !ValidarCampos(txtComplLocalConfig, "Esta��o do Local de Configura��o")
      )
        return;
    }
    ...
    if (IsEmpty(hdntxtGICN.value)) {
      alert("GIC-N � um campo obrigat�rio.");
      txtGICN.focus();
      return;
    }
  }

  //--Ajuste para Ficha T�cnica (SIR)
  ...
  if (document.Form2.hdntxtGLA.value != "")
    AdicionarNode(objXmlGeral, "hdntxtGLA", document.Form2.hdntxtGLA.value);
  if (document.Form2.hdntxtGLAE.value != "")
    AdicionarNode(objXmlGeral, "hdntxtGLAE", document.Form2.hdntxtGLAE.value);
  if (document.forms[1].strOrigemAPG.value == "APG") {
    ...
    if (
      ...
      if (check == false) {
        alert("Informe uma designa��o de tronco 2M");
        return;
      }
    }
  ...
  if (AcessoAlteradoNaoAtualizado()) {
    var intRet = alertbox(
      "As informa��es do acesso atualmente editado foram alteradas. Deseja atualiz�-la e prosseguir com a grava��o da solicita��o?",
      "Sim",
      "N�o",
      "Sair"
    );
      ...
      if (var_check[i].checked) {
        ...
        if ((var_check[i].value = "N")) {
          ...
          if (InStr(1, document.forms[0].hdnDesigServ.value, "$") != 0) {
            alert(
              "Designa��o do Servi�o � um campo obrigat�rio para esse servi�o."
            );
            return;
          }
        }
...
function AdicionarAcessoLista() {
    ...
    for (var intIndex = 0; intIndex < objNode.length; intIndex++) {
      ...
      /** retirada 09072015
				if (strcboTecnologia == "6" && document.Form2.btnAddAcesso.value == "Adicionar"){
					alert("A tecnologia GPON n�o aceita acesso misto!")
				    return
				}
				**/
    }
    ...
    if (objNode.length >= 0) {
      ...
      for (var intIndex = 1; intIndex <= treeList.length; intIndex++) {
        ...
        if (document.forms[1].hdnAcfId.value == hdnAcfId_var) {
          alert("N�o � poss�vel inserir o mesmo F�sico na Solicita��o....zz");
          return;
        }
      }
    } //if
  ...
  if (document.forms[1].hdnTipoProcesso.value == 1) {
    ...
    if (objNode.length > 0) {
      ...
      for (var intIndex = 0; intIndex < treeList.length; intIndex++) {
        ...
        if (document.forms[1].hdnAcfId.value == hdnAcfId_var) {
          alert("N�o � poss�vel inserir o mesmo F�sico na Solicita��o..");
          return;
        }
      }
    } //if
  ...
  with (document.forms[1]) {
      ...
      try {
        if (cboTipoRadio.value != "") {
          ...
          if (cboVersaoRadio.value != "") {
            alert(
              "A Vers�o do R�dio n�o deve ser preenchida sem o preenchimento do Tipo de R�dio."
            );
            return false;
          }
        }
      ...
      if (cboTecnologia[cboTecnologia.selectedIndex].innerText == "GPON") {
        ...
        /**
					if (document.forms[0].cboOrigemSol.value == 9)
					{
						...
						{
							alert('A Interface para tecnologia GPON dever� ser ADSL2+M ou VDSL')
							return false
						}
    ...
    /**
		...
		**/
    if (!ValidarCampos(cboVelAcesso, "Velocidade do Acesso F�sico"))
      return false;
    ...
    if (
      ...
      if (
        !ValidarCampos(
          cboTipoVel,
          "Para as Velocidades de 2M/34M/155M/622M o Tipo de Velocidade"
        )
      )
        return false;
    }
    if (!ValidarCampos(txtQtdeCircuitos, "Quantidade de Circuitos"))
      return false;
    if (txtQtdeCircuitos.value == 0) {
      alert("Quantidade de Circuitos dever ser maior ou igual a um.");
      return false;
    }
    ...
    /**
		...
		**/
    if (!ValidarCampos(txtEndEstacaoEntrega, "Endere�o de entrega"))
      return false;
    ...
    if (!ValidarCampos(cboTipoPonto, "Tipo do Ponto(Instala��o/Intermedi�rio)"))
      return false;
    ...
    switch (parseInt(intRet)) {
      case 1:
        ...
        /*
					...
					Altera��o realiada no dia 02/04/2007
  ...
  with (document.forms[1]) {
    ...
    if (objNodeAux.length == 1 && cboTipoPonto.value == "I") {
      if (
        ...
        alert(
          "N�o � poss�vel adicionar mais que um Ponto de Instala��o para endere�os diferentes."
        );
        return false;
      }
    }
...
function EditarAcessoLista(objChave) {
  ...
  with (document.Form2) {
    for (
      ...
      //N�o pode limpar o conte�do do radio somente fazer checked=false
      if (
    ...
    RetornaCboTipoRadio(
      ...
      RequestNodeAcesso(objXmlGeral, "cboTipoRadio", objChave.value),
      RequestNodeAcesso(objXmlGeral, "cboVersaoRadio", objChave.value)
    );
...
function AdicionarAcessoListaAprov() {
  ...
  if (objNode.length != 0) {
    ...
    for (var intIndex = 0; intIndex < objNode.length; intIndex++) {
      ...
      strcboProvedor = RequestNodeAcesso(
        objXmlGeral,
        "cboProvedor",
        objNode[intIndex].childNodes[0].text
      );
  ...
  //if( blnAchouGPON )
  //{
  //	alert("� obrigat�rio ADICIONAR pelo menos um acesso f�sico, antes da grava��o da solicita��o.")
  //	return
  //}
  //CH-21067MZM
  if (document.forms[1].hdnTipoProcesso.value == 3) {
  ...
  with (document.forms[1]) {
    ...
    try {
      if (
        cboTecnologia[cboTecnologia.selectedIndex].innerText == "GPON" ||
        cboTecnologia[cboTecnologia.selectedIndex].innerText == "FO EDD"
      ) {
        var objNode = objXmlGeral.selectNodes("//xDados/Acesso");
        /** retirada 09072015
				if (objNode.length != 0 )
...
function GravarSolicPedSNOA1() {
  with (document.forms[0]) {
    ...
    if (cboTipoAcao.value != "2" && cboTipoAcao.value != "6") {
      ...
      if (!ValidarCampos(cboTipoAcao, "Tipo da A��o")) return;

      if (!ValidarCampos(cboVelocidade, "Taxa de Transmiss�o")) return;
      if (!ValidarCampos(txtQtdLinhas, "Quantidade de Linhas")) return;

      if (!ValidarCampos(cboFinalidade, "Finalidade")) return;
      if (!ValidarCampos(cboPrazContr, "Prazo de Contrata��o")) return;
      if (!ValidarCampos(cboVelocidade, "Taxa de Transmi��o")) return;
      if (!ValidarCampos(cboCaracTec, "Caracter�stica T�cnica")) return;
      if (!ValidarCampos(cboAplicacao, "Aplica��o")) return;
      ...
      //if (!ValidarCampos(txtPontoRefencia_A,"Ponto de Refer�ncia da Ponta A")) return

      if (!ValidarCampos(txtContatoEnd_A, "Contato da Ponta A")) return;
      if (!ValidarCampos(txtTelEnd_A, "Telefone da Ponta A")) return;
      if (!ValidarCampos(txtEmailTec_A, "Email Contato T�cnico")) return;
      if (!ValidarCampos(txtUsuario_A, "Usu�rio da Ponta A")) return;
      if (!ValidarCampos(cboInterfFisica_A, "Interface F�sica da Ponta A"))
        return;
      if (!ValidarCampos(cboInterfEletr_A, "Interface El�trica da Ponta A"))
        return;

      if (!ValidarCampos(txtLatEnd_B, "Latitude da Ponta B")) return;
      if (!ValidarCampos(txtLongEnd_B, "Longitude da Ponta B")) return;
      //if (!ValidarCampos(txtPontoRefencia_B,"Ponto de Refer�ncia da Ponta B")) return
      if (!ValidarCampos(txtUsuario_B, "Usu�rio da Ponta B")) return;
      if (!ValidarCampos(cboInterfFisica_B, "Interface F�sica da Ponta B"))
        return;
      if (!ValidarCampos(cboInterfEletr_B, "Interface El�trica da Ponta B"))
        return;
      ...
      if (!ValidarTamCampos(txtUsuario_A, 50, "Usu�rio da Ponta A")) return;
      ...
      if (
        !ValidarTamCampos(
          txtPontoRefencia_A,
          50,
          "Ponto de Refer�ncia da Ponta A"
        )
      )
        return;
      ...
      if (
        !ValidarTamCampos(
          txtPontoRefencia_B,
          50,
          "Ponto de Refer�ncia da Ponta B"
        )
      )
        return;

      if (!ValidarTamCampos(txtUsuario_B, 50, "Usu�rio da Ponta B")) return;
      ...
      if (IsEmpty(txtCproInscricaoEstadual.value)) {
        alert("Inscri��o Estadual � um campo obrigat�rio.");
        return;
      }
      //<!-- CH-28482YPU - Fim -->
    }
    ...
    if (cboTipoAcao.value == "6") {
      ...
      if (!ValidarCampos(txtDesignacaoFornecedora, "Designa��o da Fornecedora"))
        return;
      /**	
			with(document.forms[0]){
    ...
    if (cboTipoAcao.value == "3") {
      ...
      if (!ValidarCampos(txtNumPedSnoaAnt, "N�mero do Pedido SNOA Anterior"))
        return;
    }
    ...
    //if (IsEmpty(txtTelEnd_A.value)){alert('Telefone da Ponta A � um campo obrigat�rio.');return}

    //<!-- CH-83646VWR - Inicio -->
    if (cboTipoAcao.value != "1") {
      // ATIVA��O
      if (IsEmpty(txtNumPedSnoaAnt.value)) {
        alert("N�mero do Pedido Anterior do SNOA � um campo obrigat�rio.");
        return;
      }
    }
    //<!-- CH-83646VWR - Fim -->
