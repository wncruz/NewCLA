<%
'Resgata usuario logado
strLoginRede = ucase(mid(Request.ServerVariables("Logon_User"), Instr(Request.ServerVariables("Logon_User"),"\")+1))
'strLoginRede = "SIRLENE"


'If trim(strLoginRede) = "PSOUTO" Then
'	'strLoginRede = "VQDIAS"
'End IF


'If  trim(strLoginRede) = "PRSS" Then
'	strLoginRede = "DCASTRO"
'End IF


'Mensagem de bloqueio de sistema
IF strLoginRede <> "ISASV" and strLoginRede <> "DAVIF" THEN
	msg = "<p align=center><b><font color=#000080 face=Arial Black size=6>Sistema NewCLA</font></b></p>"
	msg = msg & "<p align=center><b><font color=#000080 face=Arial Black size=4>Em atualização para Projeto Sarbox no horário de 12:00hs as 13:00hs.  Dúvidas: 521-3518 ou Email:DAVIF </font></b></p>"
	Response.write msg
	response.end
END IF
...
Function ConectarGRADE()
	...
	'objConnGRADE.ConnectionString = "file name=d:\inetpub\ConexaoSQL\GRADE.udl"
