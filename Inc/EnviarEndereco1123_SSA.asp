...
Function EnviarEndereco1123_SSA()
		...
		if Not objRS.Eof and not objRS.Bof then
			...
			While Not objRS.Eof
			    ''''-----'''''
						...
						Strxml1 = Strxml1 & 	"	  <ns0:des_bairro>"& objRS("Pre_Bairro") &"</ns0:des_bairro> " & vbnewline
						Strxml1 = Strxml1 & 	"	  <ns0:num_CEP>"& objRS("Pre_Cod_Cep") &"</ns0:num_CEP> " & vbnewline
						Strxml1 = Strxml1 & 	"	 <ns0:Consulta_CNL> " & vbnewline
						Strxml1 = Strxml1 & 	"	  <ns0:des_localid>"& objRS("cid_des") &"</ns0:des_localid> " & vbnewline
