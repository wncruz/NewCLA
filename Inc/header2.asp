...
if objDicCef.Exists("AVL") then
		strGerencia = strGerencia & "'Solicitação','',0,'Pedido Embratel','',0,'Pedido Terceiro / EBT ADE','',0);" & Chr(13)

	   'strGerencia = strGerencia & "'Gerenciar Acesso','gerenciamento_main.ASP',0);" & Chr(13)
		'Call objDicPag.Add("GERENCIAMENTO_MAIN.ASP","GERENCIAMENTO_MAIN.ASP")
		blnGerencia = true
end if
...
if objDicCef.Exists("ATE") or objDicCef.Exists("MD") or objDicCef.Exists("MT") or objDicCef.Exists("GE") then
   ...
   ' ****  ALTEREI - AMEDAWA
	' strAcessoFisSub = strAcessoFisSub & "'Aceite','aceitacao_main.asp',0,"
	  strAcessoFis = strAcessoFis & "'Aceite','aceitacao_main.asp',0,"	
...
if objDicCef.Exists("MD") or objDicCef.Exists("MT") or objDicCef.Exists("GAT") or objDicCef.Exists("GE") then
   TotalAcessoFis 	= TotalAcessoFis + 1
	...
	strAcessoFis 		= strAcessoFis & "'Alteração na Alocação de Facilidade(Manobra)','Manobra.asp',0,"
...
if objDicCef.Exists("GAT") or objDicCef.Exists("GAE") or objDicCef.Exists("GE") then
   TotalAcessoFis =  TotalAcessoFis + 1
	...
	strAcessoFis = strAcessoFis & "'Alocação de Facilidades','facilidade_main.asp',0,"
...
''@@@@@@@@@@@@ RELATORIOS
   	   ...
   	   Call objDicPag.Add("RelatoriosCla.ASP","RelatoriosCla.ASP")
...
strTabelaSub_1 = strTabelaSub_1 & "'Tranferência de Carteira','TransferenciaCarteira.asp',0,"
...
'''@@@ Monta a Localização dos Menus
'	response.write(strAcessoFisSub)
...
'	Response.write "<script>alert('A2');</script>"
	...
	strConsultaSub 	= " var aMenu3_18 = new Array('Movimentação de Acessos (Lista)','consMovimentacao.asp',0,'Movimentação de Acessos Temporários (Lista)','consMovimentacaoTemp.asp',0,'Pendência de Cabo Interno','ConsPendCaboInterno.asp',0,'Pedidos por Ação','cons_Aca.asp',0,'Pedidos por Provedor e Ação','cons_ProAca.asp',0,'Pedidos por Provedor e Status','cons_ProStp.asp',0,'Pendentes de Instalação (Lista)','consPendInstalaLista.asp',0,'Pendentes de Instalação (Resumo)','consPendInstalaResumo.asp',0,'Percentual de Acessos com Serviços Ativados','consPercentAcesso.asp',0,'Preço-Provedor','javascript:window.open(""../Excel/PrecoProvedor/PrecoProvedor.xls"");',0,'Relatório de Backlogs Provedor','relapendconstacesso.asp',0,'Relatório Telco','RelaTelco.asp',0,'Qtde. de Pedidos por Provedor e Ação','cons_ProAcaQtd.asp',0,'Qtde. de Pedidos Aceitos por Provedor','cons_ProQtd.asp',0,'Qtde. de Pedidos Pendentes por Provedor','cons_ProData.asp',0,'Velocidade por Serviço','consVelServico.asp',0);"
	if blnTabelas then
		if right(strTabela,3) = "" then
...
'	Response.write "<script>alert('A5');</script>"
	strAcessoFis 	= "var aMenu1 = new Array('','5','95','','','','','',''," & strAcessoFis
	strAcessoFisSub  =  "var aMenu2_2 = new Array( "& strAcessoFisSub &");"
	strConsulta	 	= "var aMenu2 = new Array('','132','95','','','','','',''," & strConsulta
	strConsultaSub 	= " var aMenu2_18 = new Array('Movimentação de Acessos (Lista)','consMovimentacao.asp',0,'Movimentação de Acessos Temporários (Lista)','consMovimentacaoTemp.asp',0,'Pendência de Cabo Interno','ConsPendCaboInterno.asp',0,'Pedidos por Ação','cons_Aca.asp',0,'Pedidos por Provedor e Ação','cons_ProAca.asp',0,'Pedidos por Provedor e Status','cons_ProStp.asp',0,'Pendentes de Instalação (Lista)','consPendInstalaLista.asp',0,'Pendentes de Instalação (Resumo)','consPendInstalaResumo.asp',0,'Percentual de Acessos com Serviços Ativados','consPercentAcesso.asp',0,'Preço-Provedor','javascript:window.open(""../Excel/PrecoProvedor/PrecoProvedor.xls"");',0,'Relatório de Backlogs Provedor','relapendconstacesso.asp',0,'Relatório Telco','RelaTelco.asp',0,'Qtde. de Pedidos por Provedor e Ação','cons_ProAcaQtd.asp',0,'Qtde. de Pedidos Aceitos por Provedor','cons_ProQtd.asp',0,'Qtde. de Pedidos Pendentes por Provedor','cons_ProData.asp',0,'Velocidade por Serviço','consVelServico.asp',0);"
	if blnTabelas then
		if right(strTabela,3) = "" then
...
'	Response.write "<script>alert('A6');</script>"
	strGerencia	 	= "var aMenu1 = new Array('','5','95','','','','','',''," & strGerencia
	strConsulta	 	= "var aMenu2 = new Array('','132','95','','','','','',''," & strConsulta
	strConsultaSub 	= " var aMenu2_18 = new Array('Movimentação de Acessos (Lista)','consMovimentacao.asp',0,'Movimentação de Acessos Temporários (Lista)','consMovimentacaoTemp.asp',0,'Pendência de Cabo Interno','ConsPendCaboInterno.asp',0,'Pedidos por Ação','cons_Aca.asp',0,'Pedidos por Provedor e Ação','cons_ProAca.asp',0,'Pedidos por Provedor e Status','cons_ProStp.asp',0,'Pendentes de Instalação (Lista)','consPendInstalaLista.asp',0,'Pendentes de Instalação (Resumo)','consPendInstalaResumo.asp',0,'Percentual de Acessos com Serviços Ativados','consPercentAcesso.asp',0,'Preço-Provedor','javascript:window.open(""../Excel/PrecoProvedor/PrecoProvedor.xls"");',0,'Relatório de Backlogs Provedor','relapendconstacesso.asp',0,'Relatório Telco','RelaTelco.asp',0,'Qtde. de Pedidos por Provedor e Ação','cons_ProAcaQtd.asp',0,'Qtde. de Pedidos Aceitos por Provedor','cons_ProQtd.asp',0,'Qtde. de Pedidos Pendentes por Provedor','cons_ProData.asp',0,'Velocidade por Serviço','consVelServico.asp',0);"
...
'	Response.write "<script>alert('A7');</script>"
	strConsulta	 	= "var aMenu1 = new Array('','5','95','','','','','',''," & strConsulta
	strConsultaSub 	= " var aMenu1_18 = new Array('Movimentação de Acessos (Lista)','consMovimentacao.asp',0,'Movimentação de Acessos Temporários (Lista)','consMovimentacaoTemp.asp',0,'Pendência de Cabo Interno','ConsPendCaboInterno.asp',0,'Pedidos por Ação','cons_Aca.asp',0,'Pedidos por Provedor e Ação','cons_ProAca.asp',0,'Pedidos por Provedor e Status','cons_ProStp.asp',0,'Pendentes de Instalação (Lista)','consPendInstalaLista.asp',0,'Pendentes de Instalação (Resumo)','consPendInstalaResumo.asp',0,'Percentual de Acessos com Serviços Ativados','consPercentAcesso.asp',0,'Preço-Provedor','javascript:window.open(""../Excel/PrecoProvedor/PrecoProvedor.xls"");',0,'Relatório de Backlogs Provedor','relapendconstacesso.asp',0,'Relatório Telco','RelaTelco.asp',0,'Qtde. de Pedidos por Provedor e Ação','cons_ProAcaQtd.asp',0,'Qtde. de Pedidos Aceitos por Provedor','cons_ProQtd.asp',0,'Qtde. de Pedidos Pendentes por Provedor','cons_ProData.asp',0,'Velocidade por Serviço','consVelServico.asp',0);"
	if blnTabelas then
		if right(strTabela,3) = "" then
...
'Response.write "<script>alert('jdhsjdhs')</script>"
...
'Response.write "<script>alert('blnAcessoLog ' + '"&blnAcessoLog&"')</script>"
'Response.write "<script>alert('blnGerencia ' + '"&blnGerencia&"')</script>"
'Response.write "<script>alert('blnAcessoFis ' + '"&blnAcessoFis&"')</script>"
'Response.write "<script>alert('blnTabelas ' + '"&blnTabelas&"')</script>"
...
'Response.end
'strGeral = strGeral & strGerencia & strAcessoFis & strAcessoFisSub & strConsulta & strConsultaSub & strTabela & strTabelaSub & strTabelaSub_1 
...
'Response.write strGeral
'Response.end

'Response.write strGeral
'Response.write "||||||||||||<b>"
'Response.write strGerencia
'Response.write "</b>||||||||||||"
'Response.write strAcessoFis
'Response.write "||||||||||||<b>"
'Response.write strConsulta
'Response.write "</b>||||||||||||"
'Response.write strConsultaSub
'Response.write "||||||||||||<b>"
'Response.write strTabela
'Response.write "</b>||||||||||||"
'Response.write strTabelaSub
'Response.write "||||||||||||-<b>"
'Response.write strTabelaSub_1
'Response.write "</b>"
...
'Response.write objDicPag.Exists(Trim(Ucase(strPagina)))
'Response.write objDicPag.Exists(Trim(Ucase("SMBD_MAIN.ASP")))
if Not objDicPag.Exists(Trim(Ucase(strPagina))) and Not objDicPag.Exists(Trim(Ucase("SMBD_MAIN.ASP"))) then
		Response.Write "<script language=javascript >alert('USUÁRIO SEM PERMISSÃOO!');window.location.reload('../index.asp');</script>"
		Response.End
End if
...
<tr>
	<td height=12px bgcolor="#f1f1f1" valign=top>
		<div id=divMenu style="position: absolute; top: 81; left: 5; width: 760; height: 112">
			<table width="760" border="0" cellspacing="0" cellpadding="0" >
			<%
			if blnAcessoLog and blnGerencia and blnAcessoFis then
			%>
