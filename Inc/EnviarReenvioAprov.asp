		...
		Dim Acao
   		...
   		if dblAprovisiId <> "" then
			...
			If not objRSDadosCla.Eof and  not objRSDadosCla.Bof Then
				...
				Strxml = Strxml & 	"				<pabx_virtual_plataforma>" & objRSDadosCla("PABX_VIRTUAL") & "</pabx_virtual_plataforma>" & vbnewline						
				
				Strxml = Strxml & 	"				<pabx_virtual_plataforma_migracao>" & objRSDadosCla("Indicador_MIGRACAO_PABX_VIRTUAL") & "</pabx_virtual_plataforma_migracao>" & vbnewline						
				Strxml = Strxml & 	"				<tecnologia-ip>" & objRSDadosCla("Indicador_TECNOLOGIA_IP") & "</tecnologia-ip>" & vbnewline						
				Strxml = Strxml & 	"				<mudCadastral>" & objRSDadosCla("Indicador_MUD_CADASTRAL") & "</mudCadastral>" & vbnewline

				Strxml = Strxml & 	"				<rede_wireless>" & objRSDadosCla("rede_wireless") & "</rede_wireless>" & vbnewline
