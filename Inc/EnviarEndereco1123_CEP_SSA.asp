<!--#include file="Mev_Biblio.asp"-->
<h1>15060606</h1>
<%
				
'Function EnviarEndereco1123_CEP_SSA()
		...
		Response.Write CEP
		Response.Write "<script language=javascript>alert('"&CEP&"')</script>"
		...
		if CEP <> "" then
			...
			'While Not objRS.Eof
			    ''''-----'''''
						...
						Strxml1 = Strxml1 & 	"	  <ns0:strSystem>SSA</ns0:strSystem> " & vbnewline
						...
						Strxml1 = Strxml1 & 	"	  <ns0:des_endereco></ns0:des_endereco> " & vbnewline
						Strxml1 = Strxml1 & 	"	 <ns0:Consulta_CEP> " & vbnewline
						Strxml1 = Strxml1 & 	"	  <ns0:des_bairro></ns0:des_bairro> " & vbnewline
						Strxml1 = Strxml1 & 	"	  <ns0:num_CEP>"& CEP &"</ns0:num_CEP> " & vbnewline
						Strxml1 = Strxml1 & 	"	 <ns0:Consulta_CNL> " & vbnewline
						Strxml1 = Strxml1 & 	"	  <ns0:des_localid></ns0:des_localid> " & vbnewline
						Strxml1 = Strxml1 & 	"	  <ns0:des_uf></ns0:des_uf> " & vbnewline
						Strxml1 = Strxml1 & 	"	  <ns0:cod_localid></ns0:cod_localid> " & vbnewline
						Strxml1 = Strxml1 & 	"	  </ns0:Consulta_CNL> " & vbnewline
						Strxml1 = Strxml1 & 	"	  </ns0:Consulta_CEP> " & vbnewline
						Strxml1 = Strxml1 & 	"	 <ns0:Consulta_Pais> " & vbnewline
						Strxml1 = Strxml1 & 	"	  <ns0:nom_pais></ns0:nom_pais> " & vbnewline
						Strxml1 = Strxml1 & 	"	  </ns0:Consulta_Pais> " & vbnewline
						Strxml1 = Strxml1 & 	"	  </ns0:Consulta_Endereco> " & vbnewline
						Strxml1 = Strxml1 & 	"	  </ns0:Solicitacao> " & vbnewline
						Strxml1 = Strxml1 & 	" </ns0:Data> " & vbnewline
						...
						if xmlhttp.statusText = "OK" then
							...
							Vetor_Campos(2)="adInteger,1,adParamInput," 	& sev_seq 			
							Vetor_Campos(3)="adInteger,3,adParamInput," 	& acp_seq
							...
							strSqlRet = APENDA_PARAMSTR("SSA_sp_check_servico9",41,Vetor_Campos)
