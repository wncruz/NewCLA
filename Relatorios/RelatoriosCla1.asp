...
<form method="post" action="RelatoriosCla1.asp" name="form_cla">
<A href="RelatoriosCla1.asp" target=_self><IMG style="WIDTH: 100%; HEIGHT: 76px" height=100 src="Imagens/topo_embratel_relatorios.jpg" width="100%" border=0 ></A>
